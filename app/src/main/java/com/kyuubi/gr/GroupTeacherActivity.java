...
public class GroupTeacherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>(GroupTeacherActivity.this, android.R.layout.simple_spinner_item, spinnerArray);
        ...
        sClassid.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view,
                ...
                if (item != null) {
                    Toast.makeText(GroupTeacherActivity.this, item.toString(), Toast.LENGTH_SHORT).show();
                }
            }
        ...
        if (spinnerArray.size() == 0) {
            ...
            RequestQueue queue = Volley.newRequestQueue(GroupTeacherActivity.this);
        ...
        bGroupSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(GroupTeacherActivity.this, GroupActivity.class);
                intent.putExtra("classid",sClassid.getSelectedItem().toString());
                GroupTeacherActivity.this.startActivity(intent);
            }
        });
    }
}
